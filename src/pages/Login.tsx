          ...
          <div className={`relative rounded-[32px] px-8 py-10 ${surfacePrimary}`}>
            ...
            <div className="relative my-6">
              <div className={`absolute inset-0 flex items-center`}>
                <div className={`w-full border-t ${isDark ? 'border-white/10' : 'border-neutral-200'}`}></div>
              </div>
              <div className="relative flex justify-center text-sm">
                <span className={`px-4 ${isDark ? 'bg-[#0f172a]/95' : 'bg-white'} ${textMuted}`}>
                  O continuar con
                </span>
              </div>
            </div>
            ...
            <Button
              ...
              className={`${buttonOutline} w-full flex items-center justify-center gap-3`}
              disabled={loading}
            >
              {loading ? (
